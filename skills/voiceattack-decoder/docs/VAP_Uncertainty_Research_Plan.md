...
(Status 2026-07-09: the v0.2 amendment is DONE — this phase's spec write-up shipped. `Project_Status.md` was retired; project status moved to `Project_State_Review_Final_2026-07-09.md` + `Execution_Plan_2026-07-09.md`, both since retained in the maintainer's private notes — no longer in the repo. Phases 3–5 of this plan remain live, gated on the Probe B export.)
